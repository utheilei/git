    ...
    , m_signalMapper(new QSignalMapper(this))
{
    ...
    QFont fontLabel("SimHei");
    m_choiceLabel->setFont(fontLabel);
    DFontSizeManager::instance()->bind(m_choiceLabel, DFontSizeManager::T2);
    m_choiceLabel->setText(tr("请选择中期安装"));
...
void InstallWidget::slotSignalMap(QObject *w)
{
